...
import com.rivetlogic.emailsender.service.ClpSerializer;
...
public class TemplateClp extends BaseModelImpl<Template> implements Template {
	...
	public void setTemplateId(long templateId) {
		...
		if (_templateRemoteModel != null) {
			try {
				...
				method.invoke(_templateRemoteModel, templateId);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setValue(String value) {
		...
		if (_templateRemoteModel != null) {
			try {
				...
				method.invoke(_templateRemoteModel, value);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	private Class<?> _clpSerializerClass = com.rivetlogic.emailsender.service.ClpSerializer.class;
}